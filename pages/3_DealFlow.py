...
from ui.components import render_header, render_phase_output, render_action_button, render_metric_card, render_sidebar, render_status_card
...
with st.sidebar:
    render_sidebar("pages/3_DealFlow.py")
    render_status_card()
