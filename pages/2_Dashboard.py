...
with st.sidebar:
    render_sidebar("pages/2_Dashboard.py")

    project = get_current_project()
    if project:
        st.markdown("<hr>", unsafe_allow_html=True)
        st.markdown("<div style='font-size: 0.65rem; font-weight: 700; color: #64748B; text-transform: uppercase; letter-spacing: 0.15em; margin-bottom: 1rem; padding-left: 0.5rem;'>Current Phase</div>", unsafe_allow_html=True)
        phase_stepper(project.phase, [p.value for p in ProjectPhase])
